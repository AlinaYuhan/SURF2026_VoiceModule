...
export VOICE_ASR_WINDOW_SEC="${SURF_DEMO_ASR_WINDOW_SEC:-${VOICE_ASR_WINDOW_SEC:-8.0}}"
export VOICE_VAD_HOLDOFF_SEC="${SURF_DEMO_VAD_HOLDOFF_SEC:-${VOICE_VAD_HOLDOFF_SEC:-4.0}}"
