...
OUTPUT_DIR="${HOME}/surf_demo_release"
NAME="surf_demo_bundle"
MAKE_TAR=0
...
copy_tree "${WORKSPACE_ROOT}" "${TARGET_ROOT}/workspace/surf_demo_workspace" \
  --exclude '.git' \
  --exclude 'runtime' \
  --exclude '__pycache__' \
...
export SURF_DEMO_BUNDLE_ROOT="${TARGET_ROOT}"
...
export DEMO_RUNTIME_DIR="${TARGET_ROOT}/workspace/surf_demo_workspace/runtime"
EOF
...
cd "${ROOT}/workspace/surf_demo_workspace"
