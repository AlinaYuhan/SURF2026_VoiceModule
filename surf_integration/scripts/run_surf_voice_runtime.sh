...
export VOICE_ASR_WINDOW_SEC="${SURF_QWEN_ASR_WINDOW_SEC:-${VOICE_ASR_WINDOW_SEC:-8.0}}"
export VOICE_VAD_HOLDOFF_SEC="${SURF_QWEN_VAD_HOLDOFF_SEC:-${VOICE_VAD_HOLDOFF_SEC:-1.0}}"
